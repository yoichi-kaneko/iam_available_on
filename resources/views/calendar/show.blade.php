...
<aside id="leftsidebar" class="sidebar">
    <!-- User Info -->
    <div class="user-info">
        <div class="image"> <img src="{{ asset('assets/images/random-avatar1.jpg') }}" width="48" height="48" alt="User" /> </div>
        <div class="info-container">
            <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">John Doe</div>
            <div class="email">john.doe@info.com</div>
        ...
        <ul class="list">
            ...
            <li class="active open"> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-copy"></i><span>Extra Pages</span> </a>
                <ul class="ml-menu">
                    ...
                    <li class="active"><a href="events.html">Calendar</a></li>
        ...
        <div role="tabpanel" class="tab-pane" id="chat">
            <div class="right_menu">
                ...
                <ul class="list-unstyled">
                    <li class="online">
                        <div class="media"> <a class="float-left"> <img class="media-object " src="{{ asset('assets/images/random-avatar4.jpg') }}" alt=""> </a>
                    ...
                    <li class="online">
                        <div class="media"> <a class="float-left"> <img class="media-object " src="{{ asset('assets/images/random-avatar5.jpg') }}" alt=""> </a>
                    ...
                    <li class="online">
                        <div class="media"> <a class="float-left"> <img class="media-object " src="{{ asset('assets/images/random-avatar3.jpg') }}" alt=""> </a>
                            <div class="media-body">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="offline">
                        <div class="media"> <a class="float-left " > <img class="media-object " src="{{ asset('assets/images/random-avatar6.jpg') }}" alt=""> </a>
                            <div class="media-body">
                                <div class="media-body"> <span class="name">Joel King</span> <span class="badge badge-outline status"></span> </div>
                            </div>
                        </div>
